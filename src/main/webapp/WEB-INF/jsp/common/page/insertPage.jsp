                	...
                	<div class="row">
                    	<div class="col-md-12">
                        	<div class="form-group">
		                        ...
		                        <form:input type="text" class="form-control" path="pageNm" maxlength="50"/>
                        	</div>
                        </div>
                    </div>
                	<div class="row">
                    	<div class="col-md-12">
                        	<div class="form-group">
		                        ...
		                        <form:input type="text" class="form-control" path="url" maxlength="100"/>
                        	</div>
                        </div>
                    </div>
                   <div class="row">
...
common.init(function(){
	...
	function fnSave(){
		var url = '<c:url value="/common/page/insertPage.json"/>';
