...
(function($){
	...
	_view = {
		addEditBtn: function(setting, node) {
			...
			$$(node, consts.id.EDIT, setting).bind('click',
				function() {
					...
					$(".udtMenu").prop("readonly", false);
					$("#"+node.tId + consts.id.INPUT).keyup(function(){
		...
		editNode: function(setting, node) {
			...
			view.cancelCurEditNode(setting);
			view.selectNode(setting, node, false);
			$$(node, consts.id.SPAN, setting).html("<input style='width:200px;' type=text class='rename' id='" + node.tId + consts.id.INPUT + "' treeNode" + consts.id.INPUT + " >");
