 ...
 */
package com.insilicogen.common.jfile;
...
public class GlobalVariables {
	...
	public static final String DEFAULT_MAIN_IMAGE_APP_PATH_KEY = "no.main.image.url";
	public static final String DEFAULT_NO_IMAGE_APP_PATH_KEY = "no.image.url";
	public static final String DEFAULT_PYTHON_SCRIPT_PATH_KEY = "python.script.path";

	public static final String DEFAULT_NODE_PDF_PATH_KEY = "node.pdf.path";

	public static final String DEFAULT_NODE_SCRIPT_PATH_KEY = "node.script.path";
